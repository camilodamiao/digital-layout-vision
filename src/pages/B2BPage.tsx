    ...
    <div className="min-h-screen" style={{ backgroundColor: '#102A3F' }}>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button 
          ...
          className="text-white font-semibold px-6 py-4 shadow-2xl animate-pulse hover:scale-105 transition-all duration-300"
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-video rounded-lg overflow-hidden shadow-2xl" style={{ backgroundColor: '#1a365d' }}>
        ...
        <div className="py-20" style={{ backgroundColor: '#4FC3F7', margin: '0 -1.5rem', padding: '5rem 1.5rem', borderRadius: '1rem' }}>
        ...
        <div className="py-20">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              <Card key={index} className="bg-gray-800 bg-opacity-50 border border-gray-700 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-white font-bold text-lg" style={{ backgroundColor: '#60AB4B' }}>
        ...
        <div className="py-20">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            {platformFeatures.map((feature, index) => (
              <div key={index} className="flex items-center space-x-4 p-4 rounded-lg bg-gray-800 bg-opacity-30 hover:bg-opacity-50 transition-all duration-300">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center text-gray-300">
                  <Phone className="w-4 h-4 mr-3" style={{ color: '#60AB4B' }} />
                  <span>(11) 99999-9999</span>
                </div>
                <div className="flex items-center text-gray-300">
                  <Mail className="w-4 h-4 mr-3" style={{ color: '#60AB4B' }} />
                  <span>contato@educanextest.com.br</span>
                </div>
                <div className="flex items-start text-gray-300">
                  <MapPin className="w-4 h-4 mr-3 mt-1" style={{ color: '#60AB4B' }} />
