...
const Index = () => {
  ...
  return (
    <BackgroundWrapper variant="minimal">
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 md:px-6 py-10 md:py-20">
        {/* Logo */}
        ...
        <div className="text-center mb-8 md:mb-16 max-w-4xl">
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold text-white mb-4 md:mb-6 leading-tight px-4">
          ...
          >
            <CardContent className="p-6 md:p-8 text-center">
              <div className="mb-6 md:mb-8">
                <div 
                  className={`w-16 h-16 md:w-20 md:h-20 mx-auto rounded-full flex items-center justify-center mb-4 md:mb-6 transition-all duration-300 ${
                ...
                >
                  <User className="w-8 h-8 md:w-10 md:h-10" style={{ color: '#60AB4B' }} />
                </div>
              ...
              <Button 
                className="w-full text-white font-semibold text-base md:text-lg py-3 md:py-4 group-hover:translate-y-[-2px] transition-all duration-300 relative overflow-hidden group" 
                style={{
          ...
          >
            <CardContent className="p-6 md:p-8 text-center">
              <div className="mb-6 md:mb-8">
                ...
                >
                  <Building2 className="w-8 h-8 md:w-10 md:h-10" style={{ color: '#4FC3F7' }} />
                </div>
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-3 md:mb-4">
                  Para Minha Empresa
                </h2>
      ...
      <Footer showExtendedContent={false} />
    </BackgroundWrapper>
  );
};
