    ...
    backgroundColor: '#102A3F'
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-20">
        ...
        <div className="mb-16 animate-fade-in">
          <img src="/lovable-uploads/bb450ec0-408d-48fd-8658-aaa1bbbfec7d.png" alt="Educa Nextest" className="h-16 md:h-20 mx-auto" />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl w-full">
          ...
          boxShadow: hoveredCard === 'b2c' ? '0 25px 50px rgba(96, 171, 75, 0.3)' : 'none'
            ...
            <CardContent className="p-8 text-center">
              <div className="mb-8">
                <div className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center mb-6 transition-all duration-300 ${hoveredCard === 'b2c' ? 'animate-pulse' : ''}`} style={{
                backgroundColor: 'rgba(96, 171, 75, 0.2)'
              }}>
                  <User className="w-10 h-10" style={{
                  color: '#60AB4B'
                }} />
                </div>
          ...
          boxShadow: hoveredCard === 'b2b' ? '0 25px 50px rgba(79, 195, 247, 0.3)' : 'none'
            ...
            <CardContent className="p-8 text-center">
              <div className="mb-8">
                <div className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center mb-6 transition-all duration-300 ${hoveredCard === 'b2b' ? 'animate-pulse' : ''}`} style={{
                backgroundColor: 'rgba(79, 195, 247, 0.2)'
              }}>
                  <Building2 className="w-10 h-10" style={{
                  color: '#4FC3F7'
                }} />
                </div>
                <h2 className="text-3xl font-bold text-white mb-4">
